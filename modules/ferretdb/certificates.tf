...
// Certificate for Ferret User
resource "kubernetes_manifest" "client_ferret_certificate" {
  manifest = {
    "apiVersion" = "cert-manager.io/v1"
    "kind"       = "Certificate"
    "metadata" = {
      "name"      = "postgresql-ferret-client-certificate"
      "namespace" = kubernetes_namespace.namespace.metadata[0].name
      "labels" = {
        "app"       = var.app_name
        "component" = "certificate"
    ...
    "spec" = {
      ...
      "commonName" = "ferret"
      "secretName" = "postgresql-ferret-client-certificate"
